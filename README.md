# Lorem Ipsum Generator — Custom Mock Paragraphs & Words

> Generate custom Lorem Ipsum placeholder text online. Choose exact word counts, sentences, paragraphs, or list items 100% offline.

[![Live Web App](https://img.shields.io/badge/Web_App-Live_Demo-3B82F6?style=flat-square)](https://cig13zs.github.io/lorem-generator/)
[![Chrome Extension](https://img.shields.io/badge/Chrome_Extension-Manifest_V3-10B981?style=flat-square)](https://github.com/cig13zs/lorem-generator/releases)
...
- **Dual Delivery:** Use directly in your browser at [https://cig13zs.github.io/lorem-generator/](https://cig13zs.github.io/lorem-generator/) or install the offline Chrome Extension package.
...
Specify the number of paragraphs or words needed. Lorem Generator generates standard classical Latin placeholder copy instantly.
...
1. Download or clone this repository:
   ```bash
   git clone https://github.com/cig13zs/lorem-generator.git
   ```
